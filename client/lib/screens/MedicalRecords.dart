...
class _MedicationManagementScreenState
                    ...
                    builder: (context, snapshot) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return _buildMedicationCard(doc.id, data, startDate,
                              endDate, times, isCompleted);
                        },
                      );
                    },
                  ),
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          color:
                              isCompleted ? Colors.grey[700] : secondaryGreen,
                          fontFamily: 'Poppins',
                        ),
                      ),
                    ),
                  ...
                  onPressed: () async {
                    if (!_showPending && !_showCompleted) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content:
                              Text('Please select at least one status filter'),
                          backgroundColor: Colors.red,
                        ),
                      );
                      return;
                ...
                try {
                  ...
                  if (mounted) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                            'Successfully deleted ${medicationName ?? 'medication'}'),
  ...
  void _showMedicationForm(
      BuildContext context, String? docId, Map<String, dynamic>? existingData) {
    ...
    if (existingData != null) {
      ...
      times = List<String>.from(
          existingData['times']?.map((t) => t.toString()) ?? ['08:00']);
                    ...
                    if (formKey.currentState!.validate()) {
                      try {
                        ...
                        if (_caregiverIds.isNotEmpty) {
                          medicationData['assignedCaregiver'] =
                              _caregiverIds.first;
                        }
